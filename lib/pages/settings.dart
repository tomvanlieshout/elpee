...
class _SettingsState extends State<Settings> {
  ...
  void _getPreferences() async {
    ...
    if (mounted) {
      setState(() {
        prefs.get(tileCountKey) == null ? tileCount = 2.0 : tileCount = prefs.get(tileCountKey);
      });
    }
  }
            ...
            child: OutlineButton(
              ...
              onPressed: () {
                if (password != null) {
                  ...
                  Helpers.showFlushbar(context, 'Password cannot be empty', Icon(FeatherIcons.alertTriangle, color: Colors.amber));
                }
              },
            ),
          ),
